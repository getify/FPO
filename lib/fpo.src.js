...
(function UMD(name,context,definition){
	...
	var publicAPI = {
		...
		constrainProps: curryMultiple( {fn: constrainProps, n: 2} ),
	...
	publicAPI.std = {
		...
		constrainProps: stdCurryMultiple( unapply( {fn: constrainProps, props: ["props","fn"]} ), /*arity=*/2),
		unary: stdUnary,
		binary: stdBinary,
		curry: stdCurry,
	...
	function constrainProps({ fn, props = [] } = {}) {
		return function constrained(argsObj = {}){
			return fn( pick( {o: argsObj, props} ) );
		};
	}

	function unary({ fn, prop: propName1 = "" } = {}) {
		return constrainProps( {fn, props: [propName1]} );
	}
	...
	function binary({ fn, props: [ propName1 = "", propName2 = "" ] = [] } = {}) {
		return constrainProps( {fn, props: [propName1,propName2]} );
	}
