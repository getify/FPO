...
(function UMD(name,context,definition){
	...
	publicAPI.classic = {
		curry: gather( {fn: publicAPI.curry, props: ["fn","n"]} ),
		curryMultiple: gather( {fn: publicAPI.curryMultiple, props: ["fn","n"]} ),
		partial: gather( {fn: publicAPI.partial, props: ["fn","args"]} ),
		complement: gather( {fn: publicAPI.complement, props: ["fn"]} ),
		apply: gather( {fn: publicAPI.apply, props: ["fn","props"] }),
		gather: gather( {fn: publicAPI.gather, props: ["fn","props"] }),
		filterIn: gather( {fn: publicAPI.filterIn, props: ["fn","arr"]} ),
		filterOut: gather( {fn: publicAPI.filterOut, props: ["fn","arr"]} ),
		map: gather( {fn: publicAPI.map, props: ["fn","arr"]} ),
		reduce: gather( {fn: publicAPI.reduce, props: ["fn","v","arr"]} ),
		reduceRight: gather( {fn: publicAPI.reduceRight, props: ["fn","v","arr"]} ),
	};

	publicAPI.std = {
		curry, curryMultiple, partial, complement, apply, gather, filterIn, filterOut,
