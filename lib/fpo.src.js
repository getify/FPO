...
(function UMD(name,context,definition){
	...
	publicAPI.std = {
		identity: gather( {fn: identity, props: ["v"]} ),
		...
		filterIn: stdCurryMultiple( gather( {fn: _applyFnProp( filterIn, ["v","i","arr"] ), props: ["fn","arr"]} ), /*arity=*/2 ),
		filterOut: stdCurryMultiple( gather( {fn: _applyFnProp( filterOut, ["v","i","arr"] ), props: ["fn","arr"]} ), /*arity=*/2 ),
		map: stdCurryMultiple( gather( {fn: _applyFnProp( map, ["v","i","arr"] ), props: ["fn","arr"]} ), /*arity=*/2 ),
		flatMap: stdCurryMultiple( gather( {fn: _applyFnProp( flatMap, ["v","i","arr"] ), props: ["fn","arr"]}), /*arity=*/2 ),
		reduce: stdCurryMultiple( gather( {fn: _applyFnProp( reduce, ["acc","v","i","arr"] ), props: ["fn","v","arr"]} ), /*arity=*/3 ),
		reduceRight: stdCurryMultiple( gather( {fn: _applyFnProp( reduceRight, ["acc","v","i","arr"] ), props: ["fn","v","arr"]} ), /*arity=*/3 ),
		flatten: stdCurryMultiple( gather( {fn: flatten, props: ["arr","n"]} ), /*arity=*/1 ),
		zip: stdCurryMultiple( gather( {fn: zip, props: ["arr1","arr2"]} ), /*arity=*/2 ),
		trampoline: gather( {fn: trampoline, props: ["fn"]} ),
	};

	// method convenience aliases
	_setMethodAlias("constant","always");
	_setMethodAlias("pipe","flow");
	_setMethodAlias("gather","unapply");
